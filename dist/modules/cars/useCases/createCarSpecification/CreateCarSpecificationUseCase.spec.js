...
describe("Create Car Specification", () => {
  ...
  it("should not be able to add a new Specification to a now-existent car", async () => {
    ...
    await expect(createCarSpecificationUseCase.execute({
      car_id,
      specifications_id
    })).rejects.toEqual(new _AppError.AppError("Car does not exitst!"));
  });
...
}); // TypeError: Cannot read property 'findByIds' of undefined == significa que o que vem antes do metodo esta vindo nulo pode ser uma classe que nao foi instanciada ou que nao foi instanciada corretamente