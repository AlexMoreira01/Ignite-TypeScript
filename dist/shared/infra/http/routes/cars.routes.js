...
const upload = (0, _multer.default)(_upload.default); // pasta passada para salvar infos
...
carsRoutes.get("/available", listAvailableCarsController.handle); // As Specificações fazem mais sentido dentro de carros
...
carsRoutes.post("/images/:id", _ensureAuthenticated.ensureAuthenticated, _ensureAdmin.ensureAdmin, upload.array("images"), // Mesmo nome da variavel que recebe as images do request no controller para encontrar
