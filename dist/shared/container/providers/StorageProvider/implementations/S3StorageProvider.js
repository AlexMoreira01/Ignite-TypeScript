...
class S3StorageProvider {
  ...
  async save(file, folder) {
    const originalName = (0, _path.resolve)(_upload.default.tmpFolder, file); // Pega o nome do arquivo

    const fileContent = await _fs.default.promises.readFile(originalName); // Leitura do arquivo
